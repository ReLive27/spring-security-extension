...
public interface JsonParser {
    ...
    JsonNode getFirstNode(final JsonNode node, final String path) throws JsonParseException;

    JsonNode getElement(final JsonNode json, final String name) throws JsonParseException;
}
